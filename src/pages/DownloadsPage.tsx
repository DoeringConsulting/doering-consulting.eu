...
const DownloadsPage: React.FC = () => {
 ...
 HEAD
  ...
  const executiveSummaryFile = currentLanguage === 'en' ? './downloads/executive_summary_alexander_doering.pdf' : './downloads/executive_summary_alexander_doering.pdf';
 ...
 f4002094 (Sauberer Rebuild mit vollständiger Struktur)
      ...
      <DownloadsContainer>
        ...
        <DownloadsGrid>
          ...
          <DownloadCard>
            ...
            <DownloadDescription>
              {t('downloads.executiveSummary.description')}
            </DownloadDescription>
