  ...
  return (
    <IconContext.Provider value={{ size: '1em' }}>
      <FooterContainer>
        <FooterContent>
          <FooterColumn>
            <FooterTitle>Über mich</FooterTitle>
            <FooterList>
              <FooterListItem><FooterLink to="/uebermich">Profil</FooterLink></FooterListItem>
          ...
          <FooterColumn>
            ...
            <FooterList>
              <FooterListItem><FooterLink to="/fachgebiete/strategie">Strategie</FooterLink></FooterListItem>
              <FooterListItem><FooterLink to="/fachgebiete/prozesse">Prozesse</FooterLink></FooterListItem>
              <FooterListItem><FooterLink to="/fachgebiete/projekte">Projekte</FooterLink></FooterListItem>
              <FooterListItem><FooterLink to="/fachgebiete/transformation">Transformation</FooterLink></FooterListItem>
            </FooterList>
          </FooterColumn>
          <FooterColumn>
